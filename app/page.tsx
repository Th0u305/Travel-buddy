...
import { Compass, Users, MapPin, Shield, Star, ArrowRight, Globe } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Connect with like-minded travelers heading to your dream destinations.',
  },
  {
    icon: MapPin,
    title: 'Share Your Plans',
    description: 'Create detailed itineraries and let others join your next adventure.',
  },
  {
    icon: Shield,
    title: 'Verified Profiles',
    description: 'Trust ratings and reviews keep the community safe and reliable.',
  },
  {
    icon: Globe,
    ...
    <div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              ...
              <span className="text-white/90 text-sm font-medium">Your next adventure starts here</span>
            </div>
            ...
            <p className="mt-6 text-lg text-white/75 leading-relaxed max-w-xl">
              Discover compatible travel companions, share your plans, and transform solo journeys into unforgettable shared experiences.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Button asChild size="lg" variant="outline" className="rounded-xl px-8 h-12 text-base bg-white/10 border-white/25 text-white hover:bg-white/20 hover:text-white">
                <Link href="/explore">
                  Explore Travelers
                </Link>
              </Button>
      ...
      <section className="relative -mt-16 z-20">
        <div className="max-w-5xl mx-auto px-4">
          ...
          >
            {stats.map((stat, i) => (
              <div key={i} className="bg-card rounded-2xl border p-6 text-center shadow-lg shadow-black/5">
                <div className="text-2xl font-bold text-foreground flex items-center justify-center gap-1">
                  {stat.value}
                  {stat.icon && <Star className="w-5 h-5 fill-secondary text-secondary" />}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Everything you need to find the perfect travel companion and plan your next adventure.
            </p>
          </motion.div>
            ...
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <Image width={100} height={100} src={t.avatar} alt={t.name} className="w-10 h-10 rounded-full object-cover" />
                  <div>
            ...
            <div className="absolute inset-0 bg-linear-to-r from-primary/90 to-primary/70 flex items-center">
              <div className="px-8 sm:px-12 max-w-lg">
                ...
                <p className="mt-3 text-white/80 text-sm">
                  Join thousands of travelers who found their perfect travel companions.
                </p>
                <div className="mt-6 flex gap-3">
                  ...
                  <Button asChild size="lg" variant="outline" className="rounded-xl border-white/30 text-white hover:bg-white/10 hover:text-white">
