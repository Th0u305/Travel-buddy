...
export default function ResetPasswordPage() {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      forgotPasswordMutate({email : value.email, password : value.new_password})
      logoutMutate()
                      ...
                      <>
                        <InputGroup>
                          ...
                          <InputGroupAddon align="inline-end" className="cursor-pointer">
                            {
                              !showConfirmPass && 
                            <EyeOffIcon onClick={() => setShowConfirmPass(!showConfirmPass)} />

                            }
                            {
                              showConfirmPass && 
                              <EyeIcon onClick={() => setShowConfirmPass(!showConfirmPass)} />
                            }
                          </InputGroupAddon>
                        </InputGroup>
                      </>
