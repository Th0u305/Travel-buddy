...
import { useRegister, useLogin } from "@/src/tanstack/useMutation";
...
export function LoginForm({
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {     
      ...
      if (isSignUp === "Sign Up") {
        userProfileRefetch()
        return registerMutate(value)
      } if (isSignUp === "Login") {
        userProfileRefetch()
        return loginMutate(value)
      }
    },
  });
        ...
        <CardContent>
          ...
          >
            <FieldGroup>
              ...
              <Field>
                <Button type="submit" className="cursor-pointer">{isSignUp}</Button>
                <FieldDescription className="text-center">
                   Already have an account? <Link href="#" onClick={() => setIsSignUp(isSignUp === "Sign Up" ? "Login" : "Sign Up")}>{isSignUp === "Sign Up" ? "Login" : "Sign Up"}</Link>
                </FieldDescription>
              </Field>
            </FieldGroup>
          </form>
